...
---------------------------------------------------------------------
 ...
 playDomsRound :: (Hand->Board->Dom)->(Hand->Board->Dom)->Int->Int

 playDomsRound _ a b = countPlayerScore (a) board + score2

 playDomsRound a _ b = countPlayerScore (a) board + score1
